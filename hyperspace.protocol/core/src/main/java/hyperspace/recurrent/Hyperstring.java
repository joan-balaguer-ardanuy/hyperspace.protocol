...
public class Hyperstring extends Hypercube<Integer, Character> {
	...
	public Hyperstring(String name, Integer key, Character value) {
		super(Hyperstring.class, name, key, value);
	}
	...
	public Hyperstring(Hyperstring parent, Integer key, Character value) {
	...
	public Hyperstring(Hyperstring root, String name, Integer key, Character value) {
